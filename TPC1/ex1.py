...
print("                   -----------")
while True:
    op = int(input('1 - Gender\n2 - Ill by age\n3 - Ill by Cholesterol\n4 - Exit\nOption: '))
    if op == 1:
        display_dist(gender_dist(data), ['Gender', 'fa'])
    elif op == 2:
        display_dist(age_dist(data, 5), ['Age', 'Number of ill persons'])
    elif op == 3:
        display_dist(cholesterol_dist(data, 10), ['Cholesterol Levels', 'Number of ill persons'])
    elif op == 4:
        break
